...
\begin{footnotesize}
\begin{center}
\noindent\textit{Note}: The first two authors share joint first authorship.
\end{center}
\end{footnotesize}
...
\autoref{tab:fiction4_corr_per_genre} compares our model’s predictions to the human gold-standard ratings for the \textit{Fiction4} dataset's 4 genres.
