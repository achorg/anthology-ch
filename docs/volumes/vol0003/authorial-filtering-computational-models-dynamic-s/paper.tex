...
\usepackage{tabularx}   % automatic line-breaks in the description column
...
% the numbers in brackets indicating the associated affiliatiaons 
...
% hyperref warning about empty anchor on this line is harmless
\begin{document}
\maketitle
\begin{abstract}
