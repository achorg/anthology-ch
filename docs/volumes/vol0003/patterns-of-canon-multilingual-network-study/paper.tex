...
% 5.000 words, deadline: July 18, 2025
...
\section{Introduction} % (500–700 words)
...
With this methodological framework, we imply and test a relationship between degrees of canonization and textual features over multiple national literary traditions. There are at least two reasons to suspect such a correlation. %One possible link between canonization and textual features lies in the mutual shaping of style and cultural selection. 
...
\section{Background and Related Work} % (600–800 words)
...
\section{Data} \label{data}% (500–700 words)
...
\begin{table}[h!]
  \centering 
  \begin{tabular}{llrp{8cm}}  % changed last column to p{7cm}
    \toprule
...
\section{Methods} %  (900–1100 words)
...
\begin{table}[h!]
  ...
  \begin{tabular}{lll}
    ...
    %Noun-to-Word Ratio      & Based on part-of-speech tagging               & NWR \\
    \bottomrule
  \end{tabular}
...
\section{Results} % (800-1000 words)
...
\section{Discussion} % (600–800 words)
...
\section{Conclusion} % (300–400 words)
...
%\begin{figure}[h!]
%  \centering
%  \includegraphics[width=0.45\linewidth]{images/adjacency_top3_NA_features_DK_adjacencymatrix.png}
%  \caption{Time-sensitive similarity network for the Danish corpus. Nodes represent individual %texts, edges connect each text to its three nearest neighbors based on cosine similarity.}
  \label{fig:networkDK}
%  
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
%  \includegraphics[width=0.45\linewidth]{images/adjacency_top3_NA_features_EN_adjacencymatrix.png}
%  \caption{Time-sensitive similarity network for the English corpus. Nodes represent individual texts, edges connect each text to its three nearest neighbors based on cosine similarity.}
  \label{fig:networkEN}
%  
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
%  \includegraphics[width=0.45\linewidth]{images/adjacency_top3_NA_features_FR_adjacencymatrix.png}
%  \caption{Time-sensitive similarity network for the French corpus. Nodes represent individual texts, edges connect each text to its three nearest neighbors based on cosine similarity.}
  \label{fig:networkFR}
%  
%\end{figure}
...
%\begin{figure}[t!]
%  \centering
%\includegraphics[width=0.45\linewidth]{images/adjacency_top3_NA_features_DE_adjacencymatrix.png}
%  \caption{Time-sensitive similarity network for the German corpus. Nodes represent individual texts, edges connect each text to its three nearest neighbors based on cosine similarity.}
  \label{fig:networkDE}
%  
%\end{figure}
