...
\usepackage{ltablex} % longtable + X columns
\keepXColumns
\usepackage{booktabs,array}
\newcolumntype{Y}{>{\raggedright\arraybackslash}X} % wrapping, left-aligned
\usepackage{listings}
\usepackage{xcolor}
\lstset{
...
By answering these questions, our work helps to establish an empirical baseline for \emph{AI-assisted accessibility in the humanities}. It also offers a reflective critique, examining AI outputs as objects of study in their own right. In the following sections, we outline our data and methodology (\ref{sec-data-methods}), present initial observations from our experiments (\ref{sec-results}), and discuss implications for digital humanities practice (\ref{sec-discussion}), before concluding with planned next steps (\ref{sec-future-work}).
...
OpenAI and Qwen outputs received more first-place and fewer last-place rankings, but overlapping rank distributions [\ref{sec-appendix-rank-distribution}] indicate that these tendencies remain descriptive rather than inferentially significant.

\subsubsection{Qualitative evaluation of top-rated outputs}
...
\noindent
\textbf{Example for Factually Wrong Text (Figure~\ref{faltblatt})}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/m92410.jpg}
...
\noindent
\textbf{Example for Reproduction of Stereotypes (Figure~\ref{karikatur})}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/m91960.jpg}
...
\noindent
\textbf{Example for Selective Description (Figure~\ref{diagram})}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/m88415_1.jpg}
...
\caption{Distribution of historical eras in the dataset and survey subset.}
  \label{sec-appendix-rank-distribution}
\end{table}
...
\caption{Distribution of media complexity in the dataset and survey subset.}
  \label{sec-appendix-pairwise-comparison}
\end{table}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/run_analysis_boxplots.png}
\caption{Throughput, Latency, and Cost by Model}
  \label{pairwise_pvalues_heatmap}
\end{figure}

\subsection{Rank Distributions and Aggregate Performance}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/rank_counts_per_model.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/rank_distributions_boxplot.png}
...
\caption{Rank counts per object and model.}\\
\toprule
...
\subsection{Pairwise Comparison of Models}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/pairwise_pvalues_heatmap.png}
