...
\newcommand{\gr}[1]{{\selectlanguage{greek}\greekfont #1}}
...
{\includegraphics[scale=0.65]{figures/fidelityHomer-Odyssey(Greek).png}}\qquad
\subfloat[Distribution of translation fidelities of Thucydides' \textit{Historiae}.]{\includegraphics[scale=0.65]{figures/fidelityThucydides-History(Greek).png}}\qquad
