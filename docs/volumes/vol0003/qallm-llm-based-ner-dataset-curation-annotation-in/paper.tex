...
\DeclareLanguageMapping{urdu}{english}
...
\paragraph{Extraction, Manual Inspection and Preprocessing.}
...
\paragraph{Model Selection and Prompt Engineering.}
...
\paragraph{Output Parsing and Tag Conversion.}
...
\subsection{Results}
\paragraph{Experiment 1: LLM-based NER Performance}
...
\paragraph{Experiment 2: LLM-as-a-Judge on the Full QaLLM Corpus}
...
\paragraph{Responses to the research questions}
...
\paragraph{Humanistic Applications.}
