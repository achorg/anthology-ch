...
%\title{Tracing Colonial Discourse in Dutch Colonial Categorisations: A Computational Analysis of Semantic Change in Dutch Historical Newspapers, 1860-1960}
...
% then in the author block — DO NOT use the broken orcid= option
...
%\affiliation{1}{DHLab, KNAW Humanities Cluster, Amsterdam, the Netherlands}
