...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\linewidth]{figures/Figure 4.png}
...
Following the methodology presented in \cite{pedrazzini-mcgillivray-2022-machines}, we trained three separate Word2Vec~\cite{mikolov2013efficient} models for each newspaper, one per period,
...
To support our hypotheses, we also conducted a \textbf{nearest neighbours analysis} for the keywords in which we observed one of the semantic change scenarios.
