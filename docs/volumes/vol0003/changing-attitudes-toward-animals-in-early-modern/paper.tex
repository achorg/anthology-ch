...
\caption{Test set accuracy for various prompts.}
  \label{sec:performance-per-attitude}
\end{table}

\section{Prompt-model combination performance per attitude}
...
\section{Performance on test set, over time}
