...
\paragraph{Inter-community edge ratio} For each node $i$, we computed the proportion of its incident edges that connect to nodes in other communities (i.e., edges labeled as inter-community).
...
\paragraph{Semantic diversity (normalized entropy)}
