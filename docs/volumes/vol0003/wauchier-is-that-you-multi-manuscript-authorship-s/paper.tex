%deadline 18 of july
%5000 words (ca. 10 pages, references, abstract and tables/illustrations excluded)

% Proposition de tire : Who Wrote the Vie de saint Lambert? Combining HTR and Stylometry to explore Medieval Manuscripts
% Investigating the Authorship of the Vie de saint Lambert
%When Machines Read Saints' Lives: Testing Wauchier's Authorship of the Vie de saint Lambert
...
% Comment to have the preprint
% \def\isanonymous{false}
% Set \isanonymoustrue or \isanonymousfalse somewhere in your document preamble
...
\noindent
\textbf{The Lambert's situation again ?}
...
\begin{table}[h]
    \centering
    \begin{tabular}{P{.2\linewidth}|p{.8\linewidth}}  % Adjust width as needed
        \toprule
