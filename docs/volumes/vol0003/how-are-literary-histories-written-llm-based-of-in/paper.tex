...
\subsection{Research Questions}%SM + AP + EG
...
%One of the few systematic studies of German-language literary histories is by Wernfried Hofmeister. Based on 18 examples concerning Wittenwiler’s \textit{Der Ring}, he describes “summaries” in literary histories as formally separated, written in the present tense and neutral in tone, and as concise condensations that include at minimum the core plot as well as key characters and locations.
...
%+ wir wissen nicht, was am besten ist, probieren es aber aus; 2. Zuerst String-Manipulation, weil es eben hin- und wieder klappt

\section{Formalizing Literary Historiography}%SM + AP
\subsection{Categories: Objects and Perspectives in Literary Histories}%SM + AP
...
%However, since we are annotating sequences of text, we cannot speak about \enquote*{methods} in the traditional sense, but rather call them \emph{analytical perspectives}% from which an object is described.
...
\begin{enumerate}
  ...
  % \item \textbf{Not Classifiable} 
  % Used when no suitable object category can be assigned or the reference is ambiguous.
\end{enumerate}



\noindent
\textbf{Analytical Perspectives.}
...
\begin{enumerate}
  ...
  % \item \textbf{Not Classifiable} refers to the object not being classifiable under any of the above categories.
\end{enumerate}


\subsection{Segments: Propositions in Literary Histories}%SM + AP
...
%The sentence above is accordingly split into the following %propositions: 

%\begin{enumerate}
%    \item The concept associated with the term \enquote*{Classicism} was shaped by Goethe.
%    \item The concept associated with the term \enquote*{Classicism} was shaped by the city of Weimar.
%    \item The city of Weimar was always associated in the minds of contemporaries with the literary works of Goethe.
%    \item The city of Weimar was always associated in the minds of contemporaries with the literary works of Schiller.
%    \item The city of Weimar was always associated in the minds of posterity with the literary works of Goethe.
%    \item The city of Weimar was always associated in the minds of posterity with the literary works of Schiller.
%\end{enumerate}
...
\noindent
\textbf{Proposition Extraction.} The extraction process systematically decomposes complex or coordinated sentences into independent propositional units. It was performed using GPT-4.1. This enables targeted analysis and machine-readable representation.
...
\noindent
\textbf{Iterative Development of Annotation Guidelines.}
...
\noindent
\textbf{Evaluation-Based Selection of a Model-Prompt Combination.}
...
%Kats: nicht strikte top-down-op, sondern explorativ-iterativ unter Berücksichtigung des Vorverständnisses der LLMs
...
\noindent
\textbf{Distribution of objects and analytical perspectives.}
...
\noindent
\textbf{Distribution of combinations of objects and analytical perspectives.}
...
%Auszufüllen im Falle einer Annahme
...
% Jupyter Notebook-ähnlicher Stil
\lstset{
...
% Stil für die Boxen
\tcbset{
    colback=gray!10, % Hintergrundfarbe
    colframe=black, % Rahmenfarbe
    fonttitle=\bfseries, % Titel fett
    coltitle=black, % Titelfarbe
    boxrule=0.5mm, % Rahmenstärke
    arc=2mm, % Abgerundete Ecken
    left=2mm, % Innenabstand links
    right=2mm, % Innenabstand rechts
    top=2mm, % Innenabstand oben
    bottom=2mm % Innenabstand unten
}
%TC:ignore
% Deutscher Prompt
