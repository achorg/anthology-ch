...
%\footnote{While both experiments rely on heatmap visualizations for interpretability, Experiment 1 uses Grad-CAM to interpret cluster formation, whereas Experiment 2 extends this to similarity retrieval and cross-model attention analysis.}.



\noindent
\textbf{Models and embeddings.}
...
\noindent
\textbf{Retrieval and interpretability pipeline.}
...
\noindent
\textbf{Mean activation maps per cluster}
...
\noindent
\textbf{Similarity-based interpretability} 
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.9\linewidth}
		\centering
		%\includegraphics[width=0.48\linewidth]{figures/pca_img_docs.jpg}
