...
% straight orange annotation from PASS to FAIL
...
% FUSION BOX (shifted left by 0.5cm)
...
% Figure 3
% Cross-Entity Replacement Donut Charts
\begin{figure}[htbp]
    \centering
...
% Figure 4
% Entropy Comparison by Entity Type
\begin{figure}[htbp]
    \centering 
    \makebox[\textwidth]{%
...
% Figure 6
% Probability-Weighted Top 10 Predicted Categories for Masked Entity Terms
\begin{figure}[htbp]
    \centering
