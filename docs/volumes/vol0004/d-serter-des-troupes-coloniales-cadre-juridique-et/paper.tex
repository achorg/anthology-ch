...
%La désertion militaire dans la Caraïbe française au \textsc{xviii}\textsuperscript{e} siècle offre un terrain d'observation privilégié pour étudier l'impact du changement juridique sur les pratiques individuelles. En développant des modèles de reconnaissance automatique de texte et de segmentation adaptés aux archives coloniales, cette recherche analyse 127 dossiers judiciaires de déserteurs. Les résultats montrent une corrélation entre l'ordonnance de 1776 transformant la peine de mort en travaux forcés et l'augmentation des désertions, particulièrement à Saint-Domingue. Cette étude tend à montrer que les soldats connaissent la législation et ajustent leurs comportements selon la connaissance qu’ils en ont, tout en soulignant la complexité des motivations individuelles derrière les tendances statistiques.\\
%SG: proposition: 
...
\begin{table*}[htp]
    ...
    \resizebox{1\linewidth}{!}{
        \begin{tabular}{lllll}
            ...
            \midrule
            Abréviation & Esperluette (\&) & Conservation & \& & \includegraphics[height=1.25em]{images/&.png}\\
            Abréviation & Sommes d'argent & Guillemets droits \texttt{"} (\texttt{U+22}) & 4010\textasciicircum lt {\texttt{"}} {\texttt{"}} & \includegraphics[height=1.25em]{images/4010lt.png}\\
            Abréviation & Suscrites & Précédé de \textasciicircum (\texttt{U+02C6}) & la D\textasciicircum lle & \includegraphics[height=1.25em]{images/Dlle.png} \\
            Agglutination & Pas d'apostrophe & Respect du système & jay lhonneur & \includegraphics[height=1.25em]{images/jay-lhonneur.PNG}\\
            Signe & Croisettes & Croisettes\ {\fontspec{Noto Serif}※}
※ (\texttt{U+203B}) & intentions\ {\fontspec{Noto Serif} ※} & \includegraphics[height=1.25em]{images/intentions.croisette.png} \\
            Correction & Rature lisible & Entre doubles-crochets (\texttt{U+301A} et \texttt{U+301B}) & [[une]] & \includegraphics[height=1.25em]{images/une_crochet.lisible_.png}\\
            Correction & Rature lisible & Entre doubles-crochets (\texttt{U+301A} et \texttt{U+301B}) & ses [[...]] & \includegraphics[height=1.25em]{images/ses_crochet.illisible_.png}\\
            \bottomrule
        \end{tabular}
    }
